async function enviarScript(scriptText){
	...
	for(const line of lines){
		...
		setTimeout(() => {
			(main.querySelector(`button[aria-label="Enviar"]`) || main.querySelector(`button[aria-label="Enviar"]`) || main.querySelector(`button[aria-label="Send"]`) || main.querySelector(`button[aria-label="Send"]`)).click();
		}, 100);
